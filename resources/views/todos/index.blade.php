        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-group">
                    ...
                    @if($todo->finished)
                      <a class="btn btn-xs btn-success float-right mr-2" href="#"><i class="far fa-check-circle"></i></a>
                    @else
                      <a class="btn btn-xs btn-dark float-right mr-2" href="{{ route('Finished',['id' => $todo->id])}}"><i class="far fa-times-circle"></i></a>
                    @endif
                    </li>
                    @endforeach
                </ul>
